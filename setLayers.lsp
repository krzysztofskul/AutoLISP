(defun c:setMyNewLayers()
	...
	(command "_layer" "m" "L19_CABLES"
  	...
  	(command "_layer" "m" "L01_WINDOWS_SYMBOL"
		 "c" "t" "38,76,0" "L01_WINDOWS_SYMBOL"
		 "l" "CONTINUOUS" "L01_WINDOWS_SYMBOL"
		 "p" "p" "L01_WINDOWS_SYMBOL"
		 ""
	 );command
  	(command "_layer" "m" "L03_DOORS_SYMBOL"
		 "c" "t" "38,76,0" "L03_DOORS_SYMBOL"
		 "l" "CONTINUOUS" "L03_DOORS_SYMBOL"
		 "p" "p" "L03_DOORS_SYMBOL"
		 ""
	 );command
